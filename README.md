...
[![PyPI](https://img.shields.io/pypi/v/jj/2.0.0-dev.2.svg)](https://pypi.python.org/pypi/jj/2.0.0-dev.2)
[![Python Version](https://img.shields.io/pypi/pyversions/jj/2.0.0-dev.2.svg)](https://pypi.python.org/pypi/jj/2.0.0-dev.2)

## Installation

```bash
pip3 install jj==2.0.0-dev.2
```
